...
5. **Web:** `npm run dev -w @portfolio/web` (or `cd apps/web && npm run dev`). Set `NEXT_PUBLIC_API_URL` in `apps/web/.env.local` to point to the API (e.g. `http://localhost:3001`).
