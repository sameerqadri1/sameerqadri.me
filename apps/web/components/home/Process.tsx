          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {STEPS.map(({ icon, title, description, optional }, index) => (
              ...
              >
                ...
                <div className="mb-4">
                  <div className="w-10 h-10 bg-primary/10 rounded-xl flex items-center justify-center text-primary animate-zoom-in group-hover:bg-primary/20 group-hover:scale-110 transition-all duration-300" style={{ transitionDelay: `${index * 0.08 + 0.15}s` }}>
