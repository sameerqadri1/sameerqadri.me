...
export function Hero() {
  return (
    <section className="relative min-h-screen flex items-center pt-28 pb-24 overflow-hidden">
      ...
      <div className="pointer-events-none absolute bottom-0 left-0 w-[400px] h-[400px] bg-primary/10 rounded-full blur-[120px] translate-y-1/4" />

      <div className="container mx-auto px-6 relative z-10 animate-fade-up">
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/30 bg-primary/10 text-primary text-xs font-semibold tracking-[0.2em] uppercase mb-8">
          ...
          <p className="text-muted-foreground text-base sm:text-lg mb-10 leading-relaxed max-w-2xl mx-auto">
          ...
          <div className="flex items-center justify-center gap-5">
            <a
              ...
              aria-label="LinkedIn"
              className="w-10 h-10 rounded-full border border-border bg-card flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary/50 transition-all"
            >
